...
reference_genome_url="https://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/000/001/735/GCF_000001735.4_TAIR10.1/GCF_000001735.4_TAIR10.1_genomic.fna.gz"
reference_annotation_url="https://ftp.ncbi.nlm.nih.gov/genomes/all/GCF/000/001/735/GCF_000001735.4_TAIR10.1/GCF_000001735.4_TAIR10.1_genomic.gtf.gz"
...
bbduk.sh -Xmx${memory}g in1=${fastq_1} in2=${fastq_2} out1=${trimmed_1} out2=${trimmed_2} threads=${threads} ref=adapters.fa minlen=50 qtrim=r trimq=15 k=23 ktrim=r hdist=1 mink=11 tpe tbo &&  # see https://jgi.doe.gov/data-and-tools/software-tools/bbtools/bb-tools-user-guide/bbduk-guide/ for details on the settings of this trimmer
...
echo "annotation=*GCF_*.gtf.gz" >> index_genome.batch
